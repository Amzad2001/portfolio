...
const SOCIALS = [
  {
    label: "GitHub", href: "https://github.com/Amzad2001",
  ...
  {
    label: "LinkedIn", href: "https://www.linkedin.com/in/amzadshaiksoftwaredeveloper/",
  ...
  {
    label: "Email", href: "mailto:amzad.msak@gmail.com",
    hover: "hover:text-sky-500 dark:hover:text-sky-400 hover:border-sky-400/40 hover:bg-sky-50 dark:hover:bg-sky-400/10",
    svg: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="18" height="18"><rect x="2" y="4" width="20" height="16" rx="2.5"/><path d="M2 7.5l10 6.5 10-6.5"/></svg>,
  },
];
          ...
          <div className="hero-left-mobile flex flex-col items-center md:items-start text-center md:text-left gap-6 order-2 md:order-1">
            ...
            */}
            ...
            <p className="hau3 hero-f-body hero-desc-mobile max-w-lg text-[0.92rem] sm:text-[0.98rem] leading-relaxed font-normal text-slate-500 dark:text-slate-400">
              ...
              production-ready apps with Java, Spring Boot, React, and TypeScript —
              including AI-native platforms and RAG pipelines. Based in Hyderabad.
            </p>
            ...
            */}
            <div className="hau4 w-full sm:w-auto">
              <a
                href="/resume.pdf"
                download="Amzad_Shaik_Resume.pdf"
            ...
            */}
            ...
            >
              ...
              <div className="relative z-10 w-full h-full rounded-full overflow-hidden"
                ...
                <img src={profilePic} alt="Amzad Shaik" className="w-full h-full object-cover" />
              </div>
            </div>

            {/* Name tag — UNCHANGED */}
            <div className="text-center">
              <p className="hero-f-display text-[0.58rem] font-bold tracking-[0.28em] uppercase text-slate-400/60 dark:text-white/20">Amzad Shaik</p>
              <div className="flex items-center justify-center gap-2 mt-1">
                <div className="w-5 h-px bg-blue-400/30" />
                <p className="hero-f-body text-[0.5rem] tracking-[0.2em] uppercase text-slate-400/50 dark:text-white/15">Full Stack Developer</p>
