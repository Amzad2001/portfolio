...
const SKILLS = ["Java","Spring Boot","Microservices","REST APIs","React.js","Next.js","TypeScript","Node.js","FastAPI","PostgreSQL","MySQL","MongoDB","Redis","RAG / LLMs","Docker","AWS / Azure"];
const STATS  = [{ val:"2+",label:"Years Experience" },{ val:"8+",label:"Projects Completed" },{ val:"15+",label:"Tech Stacks" },{ val:"HYD",label:"Based in Hyderabad" }];
const VALUES = [
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-16 py-24 lg:py-32">
        ...
        <div className={`ab-reveal ${secVis?"ab-visible":""} mb-16 px-8 py-8 rounded-2xl border border-slate-200 dark:border-white/[0.07] bg-white dark:bg-white/[0.025] relative overflow-hidden`}>
          ...
          <p className="ab-f-serif relative z-10 text-slate-500 dark:text-white/65"
            ...
            "I build production systems that turn ideas into working products — from Java microservices to AI-native platforms with RAG pipelines."
          </p>
          <p className="ab-f-body mt-4 text-[0.7rem] tracking-[0.18em] uppercase text-slate-400 dark:text-white/28 relative z-10">— Amzad Shaik</p>
        </div>
        ...
        <div ref={bodyRef} className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start mb-16">
          ...
          <div className={`ab-reveal ${bodyVis?"ab-visible":""}`}>
            <div className="relative rounded-2xl overflow-hidden aspect-[4/5] bg-slate-100 dark:bg-white/[0.04] border border-slate-200 dark:border-white/[0.08]">
              <img src={aboutImage} alt="Amzad Shaik" className="w-full h-full object-cover" />
          ...
          <div className={`ab-reveal ab-d2 ${bodyVis?"ab-visible":""} flex flex-col gap-7`}>
            <div>
              <h3 className="ab-f-display text-[1.05rem] font-bold tracking-[0.12em] uppercase text-slate-900 dark:text-white mb-2">Amzad Shaik</h3>
              <p className="ab-f-serif text-[1.0rem] font-light italic text-slate-500 dark:text-white/45">Full Stack Developer · Hyderabad, India</p>
            </div>

            <div className="space-y-3">
              <p className="ab-f-body text-[0.92rem] leading-relaxed font-light text-slate-600 dark:text-white/55">
                I'm a Full Stack Developer with 2+ years of experience shipping scalable applications using Java, Spring Boot, microservices, and REST APIs, plus React.js and TypeScript on the frontend. I currently build AI-native platforms at Ensar Solutions.
              </p>
              <p className="ab-f-body text-[0.88rem] leading-relaxed font-light text-slate-500 dark:text-white/40">
                I work across RAG pipelines, LLM integrations, and event-driven systems with PostgreSQL, MongoDB, and Elasticsearch. B.Tech in Computer Science from Priyadarshini College of Engineering and Technology, Nellore.
              </p>
            </div>
