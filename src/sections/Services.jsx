...
const SERVICES = [
  {
    ...
    desc:"From pixel-perfect frontends to rock-solid backend APIs — I architect and ship complete web products. React/Next.js SPAs, Java Spring Boot microservices, and AI-native platforms — I handle the full vertical.",
    points:["React, Next.js & TypeScript","Java, Spring Boot & REST APIs","PostgreSQL, MongoDB & Redis","Auth, Docker & cloud deploy"],
    icon:(c) => (
