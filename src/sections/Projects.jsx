...
const PROJECTS = [
  { id:1, title:"LaunchForge — AI Idea-to-Production", desc:"AI-native SaaS that turns a founder's natural-language idea into domain models, OpenAPI specs, and production-ready frontend/backend code with RAG, live preview, and Dockerized infra.", thumb:null, color:"99,102,241", accent:"#6366f1", tags:["Next.js","TypeScript","FastAPI","AI"], live:"#", source:"#" },
  { id:2, title:"MoonLeague — Real-Time Trading Game", desc:"Event-driven trading game with Spring Boot REST APIs, WebSockets, Finnhub live market data, PostgreSQL snapshots, and a Unity WebGL game embedded in React. Deployed on Azure.", thumb:null, color:"16,185,129", accent:"#10b981", tags:["React","Java","PostgreSQL","WebSockets"], live:"#", source:"#" },
  { id:3, title:"PersonalFreedom.ai — Therapy Platform", desc:"Multi-tenant therapy transcription platform with LLM auto-summarisation, SQL Server tenancy, MongoDB transcripts, Azure Blob media pipelines, and a React/TypeScript frontend.", thumb:null, color:"14,165,233", accent:"#0ea5e9", tags:["React","TypeScript","MongoDB","AI"], live:"#", source:"#" },
  { id:4, title:"Nxt Trendz – E-Commerce Frontend", desc:"Responsive e-commerce app with authentication, protected routes, product listing and cart management using Context API.", thumb:nxtTrend, color:"0,191,255", accent:"#00bfff", tags:["React","JWT","Tailwind CSS","REST APIs"], live:"https://nexttrendsse.ccbp.tech", source:"#" },
  { id:5, title:"Nxt Watch – Video Streaming Platform", desc:"YouTube-like platform with login, protected routes and video browsing. JWT authentication and REST APIs for secure access.", thumb:nextWatch, color:"185,78,255", accent:"#b94eff", tags:["React","JWT","Tailwind CSS","REST APIs"], live:"https://youte2.ccbp.tech", source:"#" },
  { id:6, title:"Portfolio Website", desc:"Personal portfolio showcasing projects, skills and experience. React + Tailwind with dark/light theme system.", thumb:portfolioImg, color:"0,255,136", accent:"#00ff88", tags:["React","Tailwind CSS","JavaScript","Vercel"], live:"https://portfolio-m-ruddy-psi.vercel.app/", source:"#" },
  { id:7, title:"Jobby App – Job Search Platform", desc:"Job portal with authentication, filters and detail views. Handles loading, failure states and reusable components.", thumb:jobbyApp, color:"255,159,67", accent:"#ff9f43", tags:["React","JWT","Tailwind CSS","REST APIs"], live:"https://jobygane.ccbp.tech", source:"#" },
  { id:8, title:"PrimeCommerce – Full Stack App", desc:"Full-stack e-commerce with RESTful APIs, JWT auth, login/logout and password recovery workflows.", thumb:binkit, color:"255,45,120", accent:"#ff2d78", tags:["React","Node.js","MongoDB","REST APIs"], live:"#", source:"#" },
];
...
export default function Projects() {
  ...
  const filters = ["all","React","AI","Java","Node.js","MongoDB"];
