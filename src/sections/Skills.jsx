...
const Svg = {
  ...
  Java: () => <svg viewBox="0 0 32 32" width="24" height="24" fill="none"><path d="M16.8 18.6c-3.2 1.9.6 3.7 3.6 1.3-.4-.3-.8-.6-1.1-.8-1.4.6-2 .4-2.5-.5zM15.4 16.2c-2.9 2.1 1.8 3.6 2.8 1.1-.3-.2-.7-.4-1-.6-1 .6-1.4.4-1.8-.5z" fill="#5382A1"/><path d="M19.6 21.6c-4.1 1.2-4.5-2.2-2-.3.4.3.8.5 1.2.8 1.3-.9 2.6-1.6.8-.5z" fill="#E76F00"/><path d="M22.2 24.6s1.4.8-.4 2.1c-3.4 2.5-14.2 1.3-14.4-.2 0 0 .8.6 4.6 1.2 5.1.7 13.1-.2 10.2-3.1zM13.2 20.4s-2.3.6-1.1 1.7c2.4 2.1 11.7 1.5 13.3-.3 0 0-.7.6-3.1.8-2.3.3-5.8.2-7.5-.6-1.5-.6-1.6-1.6-1.6-1.6z" fill="#E76F00"/><path d="M24.6 26.8c-3.9 2.3-12.3 1.2-13.2.3 1.8 1.5 10.5 2.4 15.1.1-.5-.2-1.2-.6-1.9-.4zM16.7 13.5c1.6-1.8-.4-3.4-.4-3.4s2 2 .3 4c-1.7 1.9-.4 2.5-.4 2.5s-1.6-1.1.5-3.1z" fill="#5382A1"/><path d="M21.1 25.2c3.2-.9 1.6-3.2.6-2.6-.2.1-.4.3-.4.3s.3-.2.9-.1c1.8.2.5 2.9-1.1 2.4z" fill="#E76F00"/><path d="M18.2 8.2s4.8 1.2-4.5 5.5c-1.7.8 1.3 2.5 3.6 3.5 0 0-3.9-2-3.5-4.3.4-2 4.4-4.7 4.4-4.7zM14.5 15.2c-.3.4.2.8.8 1.1 0 0 .2-.1.3-.2-.9-.3-1.4-.7-1.1-.9z" fill="#5382A1"/></svg>,
  Spring: () => <svg viewBox="0 0 32 32" width="24" height="24" fill="none"><circle cx="16" cy="16" r="13" fill="#6DB33F"/><path d="M22.8 10.2c-1.6 1.8-3.6 2.6-6.4 2.6H15l-.3 1.6h1.2c2.1 0 3.6.4 4.6 1.3 1.4 1.2 1.6 3.1.7 5.1-.9 2-2.7 3.2-5 3.2-3.6 0-5.8-2.3-5-5.6.6-2.5 2.6-4.1 5.8-4.6l.6-3.2h-6.8l-.6 3h1.8c-.7 3.6 1.1 6.8 5.2 6.8 2.6 0 4.6-1.6 5.4-4.2.8-2.6.2-5.1-1.6-6z" fill="#fff"/></svg>,
  TS: () => <svg viewBox="0 0 32 32" width="24" height="24"><rect width="32" height="32" rx="4" fill="#3178C6"/><path d="M19.5 16.4h-3.2v10.1h-2.6V16.4H10.6v-2.1h8.9v2.1zm2.4 9.8c-.7.4-1.6.7-2.7.8-1.6.2-2.9-.3-3.7-1.3-.5-.6-.8-1.4-.8-2.3h2.4c0 .5.2.9.5 1.2.4.3.9.5 1.6.4.8 0 1.4-.2 1.8-.5.4-.3.6-.8.6-1.3 0-.5-.2-.8-.6-1.1-.4-.3-1.1-.5-2-.7l-.8-.2c-1.4-.3-2.4-.8-3-1.6-.6-.8-.9-1.7-.9-2.8 0-1.1.3-2 1-2.7.7-.7 1.8-1.1 3.2-1.1 1.2 0 2.2.3 3 .8.8.5 1.3 1.3 1.4 2.3h-2.5c-.1-.5-.3-.8-.7-1.1-.4-.2-.8-.4-1.4-.4-.6 0-1.1.1-1.4.4-.3.3-.5.6-.5 1.1 0 .5.2.8.6 1.1.4.3 1.1.5 2 .7l.9.2c1.3.3 2.3.8 2.9 1.6.6.8.9 1.7.9 2.8 0 1.2-.4 2.2-1.1 2.9z" fill="#fff"/></svg>,
  Next: () => <svg viewBox="0 0 32 32" width="24" height="24" fill="currentColor"><circle cx="16" cy="16" r="13" fill="#111"/><path d="M13.2 10.5h2.1l5.6 8.4V10.5h2.1v11h-2.1l-5.6-8.4v8.4h-2.1v-11z" fill="#fff"/></svg>,
  Docker: () => <svg viewBox="0 0 32 32" width="24" height="24" fill="none"><rect width="32" height="32" rx="4" fill="#2496ED"/><path d="M18.6 14.2h2.2v2.1h-2.2zm-2.8 0h2.2v2.1h-2.2zm-2.8 0h2.2v2.1H13zm-2.8 0h2.2v2.1H10.2zm2.8-2.6h2.2v2.1H13zm2.8 0h2.2v2.1h-2.2zM18.4 19.4c-3.6 0-6.1-1.8-6.1-1.8s.4 2.6 4.3 3.1c4.2.5 7.1-1.1 7.1-1.1s-1.6-.2-5.3-.2z" fill="#fff"/></svg>,
  Postgres: () => <svg viewBox="0 0 32 32" width="24" height="24" fill="none"><rect width="32" height="32" rx="4" fill="#336791"/><ellipse cx="16" cy="12" rx="6" ry="3.2" fill="#fff"/><path d="M10 12v6.5c0 1.8 2.7 3.2 6 3.2s6-1.4 6-3.2V12" fill="#fff" opacity=".85"/><ellipse cx="16" cy="18.5" rx="6" ry="3.2" fill="#fff"/></svg>,
  Redis: () => <svg viewBox="0 0 32 32" width="24" height="24" fill="none"><rect width="32" height="32" rx="4" fill="#DC382D"/><path d="M6 18.5l10 4.2 10-4.2-10-3.6-10 3.6z" fill="#fff"/><path d="M6 14.8l10 4.2 10-4.2-10-3.6-10 3.6z" fill="#fff" opacity=".8"/></svg>,
  FastAPI: () => <svg viewBox="0 0 32 32" width="24" height="24" fill="none"><circle cx="16" cy="16" r="13" fill="#009688"/><path d="M12 16.8l3.2 3.2L20.8 13" stroke="#fff" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  Python: () => (
...
const TABS = [
    ...
    skills:[{n:"Java",S:Svg.Java},{n:"JavaScript",S:Svg.JS},{n:"TypeScript",S:Svg.TS},{n:"Python",S:Svg.Python},{n:"HTML5",S:Svg.HTML},{n:"CSS3",S:Svg.CSS},{n:"SQL",S:Svg.SQL}] },
  { id:"frontend",  label:"Frontend",  emoji:"🎨", accent:"#3b82f6", rgb:"59,130,246",
    skills:[{n:"React.js",S:Svg.React},{n:"Next.js",S:Svg.Next},{n:"TypeScript",S:Svg.TS},{n:"Tailwind",S:Svg.Tailwind},{n:"Bootstrap",S:Svg.Bootstrap},{n:"REST APIs",S:Svg.REST},{n:"JWT Auth",S:Svg.JWT}] },
  { id:"backend",   label:"Backend",   emoji:"⚙️", accent:"#10b981", rgb:"16,185,129",
    skills:[{n:"Spring Boot",S:Svg.Spring},{n:"Java",S:Svg.Java},{n:"Node.js",S:Svg.Node},{n:"Express.js",S:Svg.Express},{n:"FastAPI",S:Svg.FastAPI}] },
  { id:"databases", label:"Databases", emoji:"🗄️", accent:"#8b5cf6", rgb:"139,92,246",
    skills:[{n:"PostgreSQL",S:Svg.Postgres},{n:"MongoDB",S:Svg.MongoDB},{n:"Redis",S:Svg.Redis},{n:"SQL",S:Svg.SQL}] },
  { id:"tools",     label:"Tools",     emoji:"🛠️", accent:"#06b6d4", rgb:"6,182,212",
    skills:[{n:"Docker",S:Svg.Docker},{n:"Git",S:Svg.Git},{n:"GitHub",S:Svg.GitHub},{n:"Postman",S:Svg.Postman},{n:"VS Code",S:Svg.VSCode},{n:"Vercel",S:Svg.Vercel}] },
];
