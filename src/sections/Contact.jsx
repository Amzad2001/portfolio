...
/* ── EmailJS credentials ── */
const EJS_SERVICE_ID  = "service_of7ywmk";
const EJS_TEMPLATE_ID = "template_hre3bcd";
const EJS_PUBLIC_KEY  = "HQOqlCfN3v4P-LRYz";
...
const INFO = [
  {
    label: "Email", value: "amzad.msak@gmail.com",
    href: "mailto:amzad.msak@gmail.com", accent: "#3b82f6", rgb: "59,130,246",
    icon: (c) => (
  ...
  {
    label: "Phone", value: "+91 7780203744",
    href: "tel:+917780203744", accent: "#8b5cf6", rgb: "139,92,246",
    icon: (c) => (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="none"
        stroke={c} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    label: "Location", value: "Hyderabad, India · Remote",
